...
let InterpretationController = class InterpretationController {
    ...
    constructor(interpretationService) {
        this.interpretationService = interpretationService;
    }
    interpret(body) {
        return this.interpretationService.interpret(body);
    }
};
...
], InterpretationController.prototype, "interpret", null);
exports.InterpretationController = InterpretationController = __decorate([
    (0, common_1.Controller)('interpret'),
    __metadata("design:paramtypes", [interpretation_service_1.InterpretationService])
], InterpretationController);
//# sourceMappingURL=interpretation.controller.js.map