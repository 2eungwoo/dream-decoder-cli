...
# Dream Decoder
> 꿈은 무의식이 기억/감정/경험을 재조직하는 과정에서 생성되는 복합적 심리 현상입니다. <br/>
> 누군가는 꿈에서 자신의 과거나 미래를 마주하기도 하고, 오랫동안 그리워하던 인물과 재회하기도 합니다. <br/>

> 해당 프로젝트는 이러한 꿈의 의미를 심리학적 관점에서 해몽하기 위해 LLM과 결합한 서비스입니다. <br/>
> 사용자의 자유로운 꿈의 연상으로부터 표상을 분석하고 감정과 맥락을 고려한 복합으로 해석된 개인화 응답을 제공합니다.
