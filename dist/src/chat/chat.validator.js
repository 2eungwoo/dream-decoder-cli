...
const chat_message_required_exception_1 = require("./exceptions/chat-message-required.exception");
let ChatValidator = class ChatValidator {
    ensureMessage(message) {
        if (!message?.trim()) {
            throw new chat_message_required_exception_1.ChatMessageRequiredException();
        }
    }
};
